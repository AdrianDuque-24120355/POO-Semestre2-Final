...
public class Hospital {
    ...
    public Hospital(){
        Admin administrador=new Admin(4000, 4, "AFFA", "JA123", "Jose", "Lopez", "4432", LocalDate.now(), "YOMAMA", "a@gmail.com");
    ...
    public boolean telefonoUsuario(String telefono){
        for (Usuario usuario: this.listaUsuarios){
            if(usuario.getTelefono().contains(telefono))
                return false;
        }
        return true;
    }
