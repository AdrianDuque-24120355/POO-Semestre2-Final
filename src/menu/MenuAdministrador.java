...
public class MenuAdministrador {
    ...
    public void procesarDatosMenu(int opcion, Admin admin, Hospital hospital) throws IOException {
        switch (opcion) {
            case 1:
                ...
                Paciente paciente = new Paciente(id, nombre, apellido, FechaNacimiento, telefono, tipoSangre, sexo, contraseñaPaciente, Rol.PACIENTE);
            ...
            case 2:
                ...
                Medico medico = new Medico(idM, nombreM, apellidoM, telefonoM, RFC, AñoNacimiento, contraseñaMedico, Rol.MEDICO);
    ...
    private ArrayList<String> obtenerDatosComun(Rol rol){
        ...
        System.out.println("Ingresa el numero de telefono del "+tipoUsuario+": ");
