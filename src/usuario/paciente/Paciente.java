...
public class Paciente extends Usuario{
    ...
    public Paciente(String id, String nombre, String apellidos, LocalDate AñoNacimiento, String telefono, String tipoSangre, char sexo, String contrasenia, String email, Rol rol) {
        super (id, nombre, apellidos, telefono, AñoNacimiento, contrasenia, email, Rol.PACIENTE);
